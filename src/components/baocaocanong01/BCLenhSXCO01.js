...
import {reportProductionOrdersCO01,exportExcel} from '../../services/CanOng01Service';
...
class BCLenhSXCO01 extends React.Component{
    constructor(props) {
        super(props);                
        this.state = {
            data,
    ...
    loadingPage=(offset,from,to)=>{
        ...
        reportProductionOrdersCO01(params).then(page=>{
            this.setState({
                data:page.content,
    ...
    exportXslx= async()=>{
        ...
        await reportProductionOrdersCO01(params).then(data=>{              
                console.log(data);  
            ...
            if(i==this.state.totalPages-1){
                ...
                exportExcel(dataXlsx,'lenh_sx_C1');
            } 
        }
    }
    render(){        
