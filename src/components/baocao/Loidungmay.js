...
import {reportError,exportExcel} from '../../services/MachineService';
...
class Loidungmay extends React.Component{
    constructor(props) {
        super(props);                
        this.state = {
            data,
    ...
    onExportExcel= async()=>{
        ...
        for(let i = 0; i<this.state.totalPages;i++){            
            ...
            await reportError(params).then(data=>{        
                console.log(data);    
            ...
            if(i==this.state.totalPages-1){
                exportExcel(dataXlsx,'log_error');
