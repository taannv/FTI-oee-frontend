...
import {reportErrorC3,exportExcel} from '../../services/CanOng03Service';
...
class LoiDungMayC3 extends React.Component{
    constructor(props) {
        super(props);                
        this.state = {
            data,
    ...
    loadPage=(offset,from,to)=>{
        ...
        reportErrorC3(params).then(page=>{
            this.setState({
                loadingbtn1:false,
                data:page.content,
    ...
    onExportExcel= async()=>{
        ...
        for(let i = 0; i<this.state.totalPages;i++){            
            ...
            await reportErrorC3(params).then(data=>{        
                console.log(data);    
            ...
            if(i==this.state.totalPages-1){
                exportExcel(dataXlsx,'log_error_C3');
        ...
        return(
            <Card title="LỖI DỪNG MÁY" bordered={false}>
                ...
                <Row gutter={8} style={{marginBottom:20,marginTop:20}}>
                    ...
                    <Col span={3}>
                        <br/>
                        <Button type="danger" loading={this.state.loadingbtn1} size={'small'} onClick={this.getReportErrorC3}><Icon type="read" />Xem Báo Cáo</Button>
                    </Col>
